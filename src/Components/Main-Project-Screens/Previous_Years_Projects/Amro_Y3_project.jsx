          ...
          <Grid container sm={10} xs={12}>
            <Grid item xs={12} className="limit2">
              <Amro_Previous_template
                ...
                teammembers="Ahmad Dumaidi, Fouad Turjman, Mayar Shanan, Saja Abuodeh"
            ...
            <Grid item xs={12}>
              <Amro_Previous_template
                ...
                teammembers="Ahmad Drawsheh, Ghada Issa, Kareem Awwad, Majd Barghouti, Rashiqa Ramahih"
            ...
            <Grid item xs={12}>
              <Amro_Previous_template
                ...
                teammembers="Ahmad Durra, Michel, Subhi Awwad, Tahseen Aliahmad (with help from Y2 student Amro Abou-Hachem)"
